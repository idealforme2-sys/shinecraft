...
function getSingleImage(globResult: Record<string, string>) {
  const images = Object.entries(globResult)
...
const ceramicCoatingImage = getSingleImage(
...
const paintCorrectionImage = getSingleImage(
...
const detailingImage = getSingleImage(
...
const windowTintingImage = getSingleImage(
...
const techInstallImage = getSingleImage(
